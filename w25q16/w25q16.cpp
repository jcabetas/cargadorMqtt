...
void initSPI1pins(void)
{
    ...
    palClearLine(LINE_W25Q16_CLK);
    palClearLine(LINE_W25Q16_MISO);
    palClearLine(LINE_W25Q16_MOSI);

    palSetLineMode(LINE_W25Q16_CLK,
                     PAL_MODE_ALTERNATE(5) |
                     PAL_STM32_OSPEED_HIGHEST);         /* SPI SCK.             */
    palSetLineMode(LINE_W25Q16_MISO,
                     PAL_MODE_ALTERNATE(5) |
                     PAL_STM32_OSPEED_HIGHEST);         /* MISO.                */
    palSetLineMode(LINE_W25Q16_MOSI,
                     PAL_MODE_ALTERNATE(5) |
